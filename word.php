...
$req=$conn->query($sql);
if ($req->num_rows == 0){echo"<h1>no informations added </h1><br/><b><a href=index>Go back </a></b>";}
else { while ($data = $req->fetch_assoc()){?>
...
<audio controls autoplay="autoplay">
  <source src="audio/<?php echo $data['audio']; ?>"  type="audio/mp3">
